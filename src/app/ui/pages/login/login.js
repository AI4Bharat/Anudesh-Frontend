        ...
        <>
            ...
            <Grid container>
                ...
                <Grid item xs={12} sm={9} md={9} lg={9} style={{flex:"auto", margin:"auto"}}>
                    ...
                    <button onClick={() => googleLogin()} className="w-2/5 flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg hover:bg-gray-50 m-auto">
