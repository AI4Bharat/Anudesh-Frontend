...
import wsProgressAnalyticsAPI from "@/app/actions/api/Progress/wsProgressAnalytics";
import wsPeriodicalTasksAPI from "@/app/actions/api/Progress/wsPeriodicalTask";
ChartJS.register(
  CategoryScale,
  LinearScale,
  BarElement,
...
function ProgressList() {
  ...
  const getCumulativeTasksData = async (payload, wsID) => {
    // setLoading(true);
    const cumulativeTasksAPIObj = new wsProgressAnalyticsAPI(payload, wsID, metaInfo);
  ...
  const getPeriodicalTasksData = async (payload, wsId) => {
    // setLoading(true);
    const periodicalTasksAPIObj = new wsPeriodicalTasksAPI(payload, wsId, metaInfo);
