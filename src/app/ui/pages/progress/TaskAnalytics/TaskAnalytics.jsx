...
if(isWorkspaceLevel && submit==true){
  ...
  return (
    <>
      <Grid container columnSpacing={3} rowSpacing={2} mb={2} alignItems="center">
        {/* Project Type Dropdown */}
        <Grid item xs={12} sm={isWorkspaceLevel ? 6 : 4} md={isWorkspaceLevel ? 3 : 4} lg={isWorkspaceLevel ? 3 : 4}>
        ...
        <Grid item xs={12} sm={isWorkspaceLevel ? 6 : 4} md={isWorkspaceLevel ? 2 : 4} lg={isWorkspaceLevel ? 2 : 4}>
