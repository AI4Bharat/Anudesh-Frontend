...
export const card1 = {
    ...
    content: 'Anudesh is an open-source platform dedicated to advancingthe development of state-of-the-art Language Model Modelsfor Indian languages. Our mission is to democratize accessto advanced natural language processing technologies bycreating high-quality conversational data. Create an accountand get started today!'
} 
...
export const card3 = {
    ...
    content: 'By contributing to Anudesh, you can play a vital role in enhancing language understanding and generation capabilities in Indian languages. Whether you are a linguist, developer, or language enthusiast, there are many ways to get involved and make an impact. Join us in our journey to empower individuals and communities.'
}