...
//           <button style={{ position: 'absolute', top: '10px', right: '10px', cursor: 'pointer', border: 'none', background: 'transparent', fontSize: '18px', color: 'red' }} onClick={handleclose}>X</button>
