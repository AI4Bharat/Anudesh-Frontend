const localisation = {
  ...
  "tooltip.ProjectType":" The type of the project for which the chart should be based on. Default selection is 'InstructionDrivenChat'.",
  ...
  "model_evaluation_note": "Note",
  "model_evaluation_rating": "Rating (1=worst, 7=best)",
