...
const $41d49c8a6078fe3c$export$a62758b764e9e41d = ({ renderComponent: renderComponent = (props)=>/*#__PURE__*/ (0, $eSIqy$jsx)("input", {
    ...
    const enableVoiceTyping = ()=>{
        ...
        (_target_parentNode = target.parentNode) === null || _target_parentNode === void 0 ? void 0 : _target_parentNode.insertBefore(wrapper, target);
        ...
        micBtn.onclick = async ()=>{
            ...
            if (isRecording && mediaRecorder) {
                ...
                mediaRecorder.onstop = async ()=>{
                    ...
                    var _target_selectionStart;
                    const start = (_target_selectionStart = target.selectionStart) !== null && _target_selectionStart !== void 0 ? _target_selectionStart : 0;
                    var _target_selectionEnd;
                    const end = (_target_selectionEnd = target.selectionEnd) !== null && _target_selectionEnd !== void 0 ? _target_selectionEnd : 0;
