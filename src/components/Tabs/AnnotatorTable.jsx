  ...
  const CustomFooter = ({ count, page, rowsPerPage, changeRowsPerPage, changePage }) => {
    return (
        ...
        <TablePagination
          ...
          "& .MuiInputBase-root.MuiInputBase-colorPrimary.MuiTablePagination-input": { marginRight: "10px" },
          color: dark ? "#a0a0a0" : "",
  ...
  <Box sx={{
    ...
    >
       ...
       <DialogActions sx={{ backgroundColor: dark ? "#2a2a2a" : "", borderTop: dark ? "1px solid #3a3a3a" : "" }}>
          ...
          variant="outlined"
          color="error"
          sx={{ color: dark ? "#f87171" : "", borderColor: dark ? "#f87171" : "" }}
        >
          Cancel
        </Button>
          <Button
        ...
        color="error"
        autoFocus
        sx={{ backgroundColor: dark ? "#cf5959" : "", "&:hover": { backgroundColor: dark ? "#b91c1c" : "" } }}
      >
        Confirm
      </Button>
        </DialogActions>
